using System;
using Xunit;
using static Calculator; // упрощаем вызов методов
...
public class CalculatorTests
{
    ...
    [InlineData(10, 3, '%', 1)]
    [InlineData(2, 3, '^', 8)]
    public void Compute_BasicOperations_ReturnsCorrectResult(
        double left, double right, char op, double expected)
    {
    ...
    // ----- парсинг числа в экспоненциальной нотации -----
    [Theory]
